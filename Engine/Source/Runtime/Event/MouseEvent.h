...
SL_EVENT_FORMATTER_SPECIALIZATION(sl::MouseMoveEvent);
SL_EVENT_FORMATTER_SPECIALIZATION(sl::MouseButtonDownEvent);
SL_EVENT_FORMATTER_SPECIALIZATION(sl::MouseButtonUpEvent);
SL_EVENT_FORMATTER_SPECIALIZATION(sl::MouseScrollEvent);
